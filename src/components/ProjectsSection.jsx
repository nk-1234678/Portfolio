      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="flex flex-col gap-28">
          {projects.map((project, key) => (
            <motion.div
              key={key}
              className={`rounded-lg justify-between flex flex-row ${
            ...
            >
              {/* Text Section */}
              <motion.div
                className="pl-3 pt-2 rounded-lg w-full h-68 flex flex-col gap-3"
              ...
              {/* Image Section */}
              <motion.div
                className="h-68 w-[70%] bg-purple-950 relative z-0"
